...
public abstract class BaseDaoMysqlImpl<T, ID extends Serializable> extends
	...
	public List<T> butchQuery(Integer current,Integer size){
	...
	@Override
	public List<String> getStrList(String sql,List<Object> values){
		if (values == null)
			values = new ArrayList<Object>();
		return this.getJdbcTemplate().queryForList(sql, values.toArray(), String.class);
	}
